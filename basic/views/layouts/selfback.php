            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                ...
                <div class="d-none d-xl-block ps-2">
                  <div>UID:<?= Yii::$app->user->identity->user_id?></div>
            ...
            <div class="row gx-lg-5">
              <div class="d-none d-lg-block col-lg-3">
                <ul class="nav nav-pills nav-vertical">
                  <li class="nav-item">
                    <a href="/index.php?r=userspace/message" class="nav-link">
                      私信管理
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/index.php?r=userspace/bookmark" class="nav-link">
                      我的收藏
                    </a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a href="/index.php?r=userspace/postcreate" class="nav-link">
                      文章发布
                    </a>
                  </li>
                </ul>
